...
|2025.1.0-SNAPSHOT|2.1.0-SNAPSHOT|0.34.0-SNAPSHOT
|2025.0.3-SNAPSHOT|2.0.2|0.34.0-SNAPSHOT
|*2025.0.2*|*2.0.2*|*0.33.0*
|2025.0.1|2.0.1|0.32.0
|2025.0.0|2.0.0|0.31.0
...
|2023.3.5-SNAPSHOT|1.10.0|0.31.0-SNAPSHOT
|*2023.3.4*|*1.10.0*|*0.30.0*
